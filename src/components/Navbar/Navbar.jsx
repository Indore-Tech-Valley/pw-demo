                ...
                <div className="flex items-center border border-gray-300 rounded-md px-3 py-2 max-w-md text-sm text-gray-700">
                  ...
                  <input
                    ...
                    placeholder={
                      searchService
                        ? ""
                        : `Search for ${placeholder} services...`
                    }
              ...
              <div className="flex items-center gap-6 text-xl text-gray-700">
                ...
                <div className="flex">
                  <FaCartPlus
                    ...
                    className="cursor-pointer  text-2xl"
                  />
                  <span className="text-xs flex justify-center items-center -mt-2  bg-red-500 h-4 w-4 text-white  rounded-full">2</span>
                </div>
              ...
              <div className="px-4 pb-3 space-y-3">
                ...
                <div className="flex items-center border rounded-md px-3 py-2 w-full text-sm text-gray-700">
                  ...
                  <input
                    type="text"
                    placeholder={
                      searchService ? "" : `Search for ${placeholder}...`
                    }
                    className="outline-none w-full"
                    value={searchService}
                    onChange={(e) => setSearchService(e.target.value)}
